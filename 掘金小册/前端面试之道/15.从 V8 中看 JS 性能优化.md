...
![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772c479b194d48?w=578&h=216&f=png&s=101832)

Audits 所处位置

点我们点击 Audits 后，可以看到如下的界面

![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772c52e83d97c7?w=559&h=677&f=png&s=62337)

Audits 界面

在这个界面中，我们可以选择想测试的功能然后点击 **Run audits** ，工具就会自动运行帮助我们测试问题并且给出一个完整的报告

![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772ca3d13a68ab?w=582&h=156&f=png&s=17178)

Audits 工具给出的报告

上图是给掘金首页测试性能后给出的一个报告，可以看到报告中分别为**性能、体验、SEO** 都给出了打分，并且每一个指标都有详细的**评估**

![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772cae50f7eb81?w=584&h=316&f=png&s=43013)

指标中的详细评估

评估结束后，工具还提供了一些**建议**便于我们提高这个指标的分数

![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772cbdcdaccf15?w=580&h=253&f=png&s=33837)
...
![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16772cf78a4fa18f?w=914&h=647&f=png&s=100688)
...
![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/167736409eebe688?w=800&h=599&f=png&s=60084)

V8 转化代码的过程

从上图中我们可以发现，JS 会首先被解析为 AST，解析的过程其实是略慢的。代码越多，解析的过程也就耗费越长，这也是我们需要压缩代码的原因之一。另外一种减少解析时间的方式是预解析，会作用于未执行的函数，这个我们下面再谈。

![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/1677468f20b62240?w=1177&h=554&f=png&s=293277)
...
![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/3/16773b904cfb732f?w=800&h=331&f=png&s=88685)
...
![](//images.weserv.nl/?url=user-gold-cdn.xitu.io/2018/12/4/16778338eb8b7130?w=526&h=274&f=png&s=46319)
